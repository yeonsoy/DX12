...
void RenderTargetGroup::Create(RENDER_TARGET_GROUP_TYPE groupType, vector<RenderTarget>& rtVec, shared_ptr<Texture> dsTexture)
{
	...
	// RenderTarget Vector에 대한 모든 정보를 담는 Descriptor Heap을 생성
...
// CommandQueue에서 ClearTargetView로 RenderTargetView를 Clear 후,
// OMSetRenderTargets을 이용해서 해당하는 Back Buffer에 그려주던 부분이 삭제되고 이전.
