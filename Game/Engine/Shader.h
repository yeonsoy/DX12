...
struct ShaderArg
{
    ...
    ShaderArg() : vs("VS_Main"), ps("PS_Main") {};
    ShaderArg(const string vs, const string ps) : vs(vs), ps(ps) {};
    ShaderArg(const string vs, const string hs, const string ds, const string gs, const string ps) : vs(vs), hs(hs), ds(ds), gs(gs), ps(ps) {};
